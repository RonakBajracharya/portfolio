...
export default function AdminSidebar() {
  ...
  const handleLogout = async () => {
    ...
    window.location.href = "/cyancharley/login"
  }
  ...
  return (
    <>
      ...
      <aside
        className={`fixed top-0 left-0 h-screen w-64 bg-slate-800 border-r border-slate-700 z-50 transform transition-transform duration-200 lg:sticky lg:translate-x-0 flex flex-col ${
